...
function Nav(){
    ...
    return(
        <BrowserRouter>
        <div className={`${theme==="light"?"bg-[linear-gradient(90deg,#e0e7c6,#b7eef0)]":"bg-[linear-gradient(90deg,#27012c,#501c57)] text-white"} p-3 border-b-2 border-black flex items-center justify-between px-5 fixed w-full top-0`}>
            <Link to="" onClick={()=>setActive("")} className="text-3xl font-extrabold font-[cursive]">
                <p>Bloggy</p>
            </Link>
